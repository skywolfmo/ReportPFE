...
\begin{enumerate}
      \item 
      When client makes any request, it is firstly processed by the Angular.
      \item 
...
\begin{figure}[!ht]
      \center
      \includegraphics[scale=0.40]{assets/mean.png}
      \caption{Mean Stack Response Data Flow}
      \label{fig:mean}
\end{figure}
...
SPA requests the markup and data independently and renders pages straight in the browser. We can do this thanks to the advanced JavaScript frameworks of Angular.
